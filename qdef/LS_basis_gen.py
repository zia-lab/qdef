...
from qdef.qdef import *
from collections import OrderedDict
import qdef.tensorops as to
...
|     element is a 2n-tuple (ml_1, ms_1, ml_2, ms_2, ... ml_n,     |
|      ms_n) and the second element the accompanying numeric       |
...
def Ψ_vac(qet, elem_basis):
    '''
    This  function removes the redundant parts to a ket that is assumed to
...
# def SMSLML_gen_alt(l, n_max, verbose=False):
#     '''
#     This function creates the coupled kets {S, MS, L, ML}
#     in terms of .... 
#     '''
