...
save_to_pickle = True
pickle_fname = os.path.join('./','data','three_electrons_all.pkl')
...
if __name__ == '__main__':
    all_three_electron_funs_in_all_groups = {}
    for group_label in CPGs.all_group_labels:
        ...
        all_three_electron_funs_in_all_groups[group_label] = all_three_electron_funs
    if save_to_pickle:
        print("\nSaving to pickle ...")
        pickle.dump(all_three_electron_funs_in_all_groups, open(pickle_fname,'wb'))
